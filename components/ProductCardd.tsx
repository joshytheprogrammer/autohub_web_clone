...
export default function ProductCard({ product, refetchs }: ProductDetail) 
{
    ...
    return (
              !isLoading && 
                <div 
                    className='col-span-6 md:col-span-3 lg:col-span-3 mb-5 md:mb-5 px-1 hover:rounded-md hover:p-1 hover:border-1 hover:border-green-800 border-shadow cursor-pointer'
                >
                    <div className="w-full">
                        ...
                        >
                            <div 
                                ...
                                <img 
                                    src={`${USAGE_PATH.WATER_MARK}${product?.watermark}`}
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span 
                                        className='ml-2'
                                    >
                                        {`${(product?.lga === "Not specified" ? "" : product?.lga?.name  )}`}
                                    </span>
                                </div>
                                <div 
