...
const SearchState = ({ placeholder, incomingData, countryId, stateOption, selectedState, onClick }: searchStateProps) => 
{
      ...
      return (
            ...
            >
                {
                    (countryId === -1) && <><div className="bg-white p-3 border-b-2 border-blue-300">You have to select a country first</div></>
                }
                {
                    ((incomingData.length === 0) && (countryId != -1)) && <><div className="bg-white p-3 border-b-2 border-blue-300">No State is under this country</div></>
                }
