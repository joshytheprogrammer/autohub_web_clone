...
const SelectCategory = ({ onClick, placeholder, selectedCategory, incomingData, edit }: CategoryProps) => 
{
                    ...
                    data?.map((x: any, index: number) => (
                        <li
                            ...
                            onClick={() => {
                                ...
                                setInputValue("")
                                setCategId(x?.tb_id)
                                advertState.setCategory(x?.tb_id)
                                advertState.setCategoryName(x?.name)
                                onClick(x?.tb_id)
                                // setRefresh(Math.random()*(3171*953))  
                            }}
                        >
                            {x?.name}
                        </li>
