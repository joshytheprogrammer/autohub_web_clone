            ...
            >            
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div 
                            className="border-2 border-green-200 h-[160px] md:h-[180px] flex md:flex items-center justify-center rounded-xl cursor-pointer bg-green-100 hover:bg-[#23913b] hover:text-white"
                      >
                          <div 
                          ...
                          >        
                                ...
                                >                                            
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={.5} stroke="currentColor" className="w-10 h-10 md:w-15 md:h-15">
                    ...
                    <div 
                          className="md:w-1/2 w-full"
                    >
                      <Link className='font-bold ml-2' href={'/register/affiliate'}
                      >
                        <div 
                            className="border-2 border-green-200 h-[160px] md:h-[180px] flex md:flex items-center justify-center rounded-xl cursor-pointer bg-green-100 hover:bg-[#23913b] hover:text-white"
                        >
