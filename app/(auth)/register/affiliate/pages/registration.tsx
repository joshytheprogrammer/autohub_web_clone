...
//   const [rcNumberMessage, setRcNumberMessage] = useState<string>("")
  ...
  {
      setRefresh(false)
  }, [firstname, surname, middlename, email, phone, errorMessage, refresh, companyName, companyAddress, middlenameMessage])

  const AffiliateDetail = async () => 
  {
      setLoading(true)
      await delay(2000)
  ...
  return (
           <div 
                 ...
                 >
                       ...
                       <div  
                             className='w-full flex justify-between md:flex gap-10 md:mb-3 mt-3 md:mt-14 px-5 pb-4'
                       >   
                                   <HiArrowSmLeft 
