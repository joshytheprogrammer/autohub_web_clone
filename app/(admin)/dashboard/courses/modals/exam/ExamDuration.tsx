...
import { ExamObjectiveDuration } from "../../../../../api/admin/academic/exam"
...
export const ExamDuration = ({onClick, openExamStatus, exam, token}: ExamDurationProps)  =>
{
        const [loading, setIsLoading] = useState(false)
        const [objectiveDuration, setExamObjectiveDuration] = useState<string>("")
        ...
        {
            setIsLoading(true)
            const setObjDuration = ExamObjectiveDuration(objectiveDuration, token)
