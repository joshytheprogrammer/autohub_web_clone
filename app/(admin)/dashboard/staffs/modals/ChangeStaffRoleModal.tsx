...
type ChangeStaffRoleModalProps = 
{
    onClick: () => void 
...
export const ChangeStaffRoleModal = ({onClick, openAddMember, roles, data, token}: ChangeStaffRoleModalProps)  =>
{
    ...
    { 
        setLoading(true)
        const changeRole = ChangeRole(data?.id, theRole, token)
     ...
     return (
                ...
                >
                        ...
                        >
                            <h3 className="font-bold text-md mb-4 text-blue-500 uppercase">Change Role</h3>
                            <div 
