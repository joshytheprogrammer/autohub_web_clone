...
import { UpdateCourseModule } from "../../../../../api/admin/academic/courses"


type UpdateCourseModuleModalProps = 
{
    editCourseModal: boolean,
    onClick: () => void
    token: string
    data: { id: number, course_id: number, name: string }
}

export const EditCourseModuleModal = ({onClick, editCourseModal, data, token}: UpdateCourseModuleModalProps)  =>
{
   ...
   {
      setIsLoading(true) 
      const newCourse = UpdateCourseModule(id, moduleName, token)
