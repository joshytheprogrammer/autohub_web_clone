...
import { NewCourseModule } from "../../../../../api/admin/academic/courses"


type AddCourseModuleModalProps = 
{
...
export const AddCourseModuleModal = ({onClick, openCourseModal, courseId, token}: AddCourseModuleModalProps)  =>
{
    ...
    {
       setIsLoading(true) 
       const newCourse = NewCourseModule(courseId, name, token)
    ...
    return (
             <Modal 
                onClick={onClick} isOpen={openCourseModal} wrapperWidth={800} margin={'120px auto 0px auto'}
             >
                <div 
                           ...
                           >
                                ...
                                >
                                   <input 
                                        ...
                                        type="text" id="module"
                                        name="module"  placeholder="Enter Name" 
