...
import { RemoveCourseModule } from '../../../../../api/admin/academic/courses';


type DeleteCourseModuleModalProps = 
{
...
export const DeleteCourseModuleModal = ({onClick, deleteCourseModal, data, token}: DeleteCourseModuleModalProps)  =>
{
    ...
    {
       setIsLoading(true)
       const newCourse = RemoveCourseModule(id, token)
