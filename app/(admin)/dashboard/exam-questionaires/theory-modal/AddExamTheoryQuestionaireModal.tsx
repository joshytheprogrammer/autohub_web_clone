...
import { NewExamTheoryQuestionaire } from "../../../../api/admin/academic/exam"
...
export const AddExamTheoryQuestionaireModal = ({ onClick, openQuestionaire, token }: NewQuestionaireProp)  =>
{
    ...
    {
       setIsLoading(true)
       const newCourse = NewExamTheoryQuestionaire(name, description, token)
