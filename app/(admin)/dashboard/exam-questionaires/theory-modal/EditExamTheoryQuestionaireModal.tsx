...
import { RenameExamTheoryQuestionaire } from "../../../../api/admin/academic/exam"
...
export const EditExamTheoryQuestionaireModal = ({ onClick, openQuestionaire, data, token }: UpdateQuestionaireProp)  =>
{
    ...
    {
       setIsLoading(true)
       const editQuestionaire = RenameExamTheoryQuestionaire(id, name, description, token)
