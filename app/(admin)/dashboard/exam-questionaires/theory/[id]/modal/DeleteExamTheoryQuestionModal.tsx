...
import { RemoveExamTheoryQuestion } from "../../../../../../api/admin/academic/exam"
import { BeatLoader } from "react-spinners"
import { Modal } from "../../../../../../component/modal/Modal"
import Message from "../../../../../../../components/shared/Message"


type DeleteExamTheoryModalProps = 
{
   openQuestionaire: boolean,
   onClick: () => void
   token: string
   data: { question_id: number, questionaireId: number, question: string, assigned_mark: string }
}

export const DeleteExamTheoryQuestionModal = ({onClick, data, openQuestionaire, token}: DeleteExamTheoryModalProps)  =>
{
    ...
    {
       setIsLoading(true)
       const newCourse = RemoveExamTheoryQuestion(id, token)
