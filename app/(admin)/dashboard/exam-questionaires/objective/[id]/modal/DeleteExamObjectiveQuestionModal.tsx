...
import { RemoveExamQuestion } from "../../../../../../api/admin/academic/exam"
...
type DeleteCourseModalProps = 
{
   ...
   onClick: () => void
   token: string
   data: { question_id: number, question: string, option_a: string, option_b: string, option_c: string, option_d: string, answer: string, assigned_mark: string }
}

export const DeleteExamObjectiveQuestionModal = ({onClick, data, openQuestionaire, token}: DeleteCourseModalProps)  =>
{
    ...
    {
       setIsLoading(true)
       const newCourse = RemoveExamQuestion(id, token)
