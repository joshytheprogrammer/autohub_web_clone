...
import { RenameExamObjectiveQuestionaire } from "../../../../api/admin/academic/exam"
...
export const EditExamObjectiveQuestionaireModal = ({ onClick, openQuestionaire, data, token }: UpdateQuestionaireProp)  =>
{
    ...
    {
       setIsLoading(true)
       const editQuestionaire = RenameExamObjectiveQuestionaire(id, name, description, token)
       editQuestionaire.then((response) => 
       {
