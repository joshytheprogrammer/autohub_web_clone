...
import { RemoveExamObjectiveQuestionaire } from "../../../../api/admin/academic/exam"
...
export const DeleteExamObjectiveQuestionaireModal = ({onClick, data, openQuestionaire, token}: DeleteCourseModalProps)  =>
{
    ...
    {
       setIsLoading(true)
       const newCourse = RemoveExamObjectiveQuestionaire(id, token)
