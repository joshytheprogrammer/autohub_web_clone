...
type SuspendedMemberModalProps = 
{
    onClick: () => void 
...
export const SuspendMemberModal = ({onClick, openSuspendMember, message, imageUrl, userId, userType, token}: SuspendedMemberModalProps)  =>
{
     ...
     return (
                <Modal 
                        onClick={onClick} isOpen={openSuspendMember} wrapperWidth={650} margin={'100px auto 0px auto'}
                >
                        ...
                        <div className='col-span-12 pt-1 pb-5 overflow-y-auto xm:overflow-y-scroll justify-center item-center'>
                                ...
                                >                                       
                                        ...
                                        >
                                            {       (loading === true) ? ( <BeatLoader size={9} color="#fff" className="text-white" />) : ( "Suspend Member" ) } 
                                        </button>
