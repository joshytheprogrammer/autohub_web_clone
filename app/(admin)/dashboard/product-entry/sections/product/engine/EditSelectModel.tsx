...
type SelectModelProps = 
{
    ...
    onClick: (modelId: number, modelName: string) => void
...
const EditSelectModel = ({ placeholder, selectedManufacturerName, selectedModelName, models, id, onClick, modelOption }: SelectModelProps) => 
{
                    ...
                    >
                        {
                            selected
                                ...
                                : (choosen === 'reset-model') ? '- Select Model -' : (choosen === 're-reset') ? '- Select Model -' : selected
                                : placeholder 
                        }
...
export default EditSelectModel;