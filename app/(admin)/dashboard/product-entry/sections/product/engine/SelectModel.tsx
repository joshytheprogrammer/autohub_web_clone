...
const SelectModel = ({ placeholder, selectedManufacturerName, models, id, onClick, modelOption }: SelectModelProps) => 
{
  const [inputValue, setInputValue] = useState<string>("")
  const [selected, setSelected] = useState<string>(selectedManufacturerName)
  const [open, setOpen] = useState(false) 
  const [choosen, setChoosen] = useState<string>(modelOption)

  useEffect(() => 
  {
    //  setSelected(selectedManufacturerId)
     console.log(id)
  }, [])
