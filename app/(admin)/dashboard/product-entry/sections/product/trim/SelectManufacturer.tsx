...
type SelectManufacturerProps = 
{
    ...
    manufacturers: { id: number, tb_id: number, name: string, rate: number, link: string, icon: string }[]
    id: number
}
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {
                        manufacturers?.map((x: { id: number, tb_id: number, name: string, rate: number, link: string, icon: string }, index: number) => 
                        (
                            <li
                                key={index}
