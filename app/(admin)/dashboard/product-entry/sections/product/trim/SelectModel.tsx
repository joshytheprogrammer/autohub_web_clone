...
const SelectModel = ({ placeholder, selectedManufacturer, models, id, onClick, modelOption }: SelectModelProps) => 
{
  ...
  return (
        <>
            ...
            >
            {
                (selectedManufacturer === "") && <><div className="bg-white p-3 border-b-2 border-blue-300">You have to select a manufacturer first</div></>
            }
            {
                ((selectedManufacturer != "") && (models?.length === 0)) && <><div className="bg-white p-3 border-b-2 border-blue-300">{selectedManufacturer} has no model yet</div></>
            }
            {/* {`selected - ${choosen}`} */}
                    ...
                    >
                        {
                            choosen
                                ? choosen?.length > 25 ? 
                                                            choosen?.substring(0, 25) + "..."  : (choosen == 'reset-model') ? 
