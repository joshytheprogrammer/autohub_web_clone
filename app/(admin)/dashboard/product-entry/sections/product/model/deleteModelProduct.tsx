...
import { RemoveModel } from "../../../../../../api/admin/market/product-entry/model"
...
type DeleteModelModalProps = 
{
    ...
    token: string
    data: { id: number,  manufacturer_id: number, name: string, rate: number }
}    

export const DeleteModelProduct = ({onClick, openDeleteModel, data, token}: DeleteModelModalProps)  =>
{
     ...
     const deleteProductManufacturalModal = async () => 
     { 
           setIsLoading(true)
           const deleteManufacturer = RemoveModel(id, token)
     ...
     return (
                <Modal 
                        onClick={onClick} isOpen={openDeleteModel} wrapperWidth={650} margin={'200px auto 0px auto'}
                >
                        ...
                        >
                                ...
                                >                                       
                                        ...
                                        className="w-5/12 py-3 px-4 bg-green-600 text-white font-semibold text-sm rounded-xl hover:bg-green-800"
                                                onClick={() => deleteProductManufacturalModal()}
                                        >
