...
export const DeleteFuelProduct = ({onClick, openDeleteFuel, message, userType, token}: DeleteFuelModalProps)  =>
{
     ...
     return (
                <Modal 
                        onClick={onClick} isOpen={openDeleteFuel} wrapperWidth={650} margin={'200px auto 0px auto'}
                >
