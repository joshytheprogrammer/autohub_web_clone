...
export const DeletCategoryModal = ({onClick, openDeleteCategory, message, userType, token}: DeleteCategoryModalProps)  =>
{
                ...
                >
                        ...
                        <div className='col-span-12 pt-1 pb-5 overflow-y-auto xm:overflow-y-scroll justify-center item-center'>
                                ...
                                >                                       
                                        ...
                                        >
                                            {       (loading === true) ? ( <BeatLoader size={9} color="#fff" className="text-white" />) : ( "Delete Category" ) } 
                                        </button>
