...
export const EditDepartmentModal = ({onClick, openEditDepartment, message, imageUrl, userId, userType, token}: EditDepartmentProps)  =>
{
                ...
                >
                        ...
                        <div className='col-span-12 pt-1 pb-5 overflow-y-auto xm:overflow-y-scroll justify-center item-center'>
                                ...
                                >                                       
                                   ...
                                   >
                                      {       (loading === true) ? ( <BeatLoader size={9} color="#fff" className="text-white" />) : ( "Update Department" ) } 
                                   </button>                                        
                                </div>
                           </div>
                        </div>
