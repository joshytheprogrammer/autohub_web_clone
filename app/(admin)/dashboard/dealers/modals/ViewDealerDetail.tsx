...
type ViewDealerDetailProps = 
{
    onClick: () => void 
    openViewDealer: boolean 
    imageUrl: string 
    userId: number 
    message: string
    userType: string
...
export const ViewDealerDetail = ({onClick, openViewDealer, message, imageUrl, userId, userType, token}: ViewDealerDetailProps)  =>
{
    ...
    //  const [errorMessage, setErrorMessage] = useState<string>("")
     ...
     return (
                <Modal 
                        onClick={onClick} isOpen={openViewDealer} wrapperWidth={1000} margin={'100px auto 0px auto'}
                >
