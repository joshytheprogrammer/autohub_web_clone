...
export const SuspendDealerModal = ({onClick, openSuspendDealer, message, imageUrl, userId, userType, token}: SuspendDealerModalProps)  =>
{
     ...
     return (
                <Modal 
                        onClick={onClick} isOpen={openSuspendDealer} wrapperWidth={650} margin={'100px auto 0px auto'}
                >
                        ...
                        <div className='col-span-12 pt-1 pb-5 overflow-y-auto xm:overflow-y-scroll justify-center item-center'>
                                ...
                                >                                       
                                        ...
                                        >
                                            {       (loading === true) ? ( <BeatLoader size={9} color="#fff" className="text-white" />) : ( "Suspend Dealer" ) } 
                                        </button>
