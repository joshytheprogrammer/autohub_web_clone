...
import { NewQuestionaire } from "../../../../api/admin/academic/test"
...
export const AddQuestionaireModal = ({ onClick, openQuestionaire, token }: NewQuestionaireProp)  =>
{
    ...
    {
       setIsLoading(true)
       const newCourse = NewQuestionaire(name, description, token)
