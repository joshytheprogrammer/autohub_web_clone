...
import { RemoveQuestionaire } from "../../../../api/admin/academic/test"
...
export const DeleteQuestionaireModal = ({onClick, data, openQuestionaire, token}: DeleteCourseModalProps)  =>
{
    ...
    {
       setIsLoading(true)
       const newCourse = RemoveQuestionaire(id, token)
