...
import { RenameQuestionaire } from "../../../../api/admin/academic/test"
...
export const EditQuestionaireModal = ({ onClick, openQuestionaire, data, token }: UpdateQuestionaireProp)  =>
{
    ...
    {
       setIsLoading(true)
       const editQuestionaire = RenameQuestionaire(id, name, description, token)
