...
import { QuestionaireQuestion } from "../../../../api/admin/academic/test"
import { useRouter } from "next/navigation"
import { HiArrowLeft } from "react-icons/hi2"
import { AddTestQuestionModal } from "./modal/AddTestQuestionModal"
import { Icons } from "../../../../../components/shared/Icons"
import { EditTestQuestionModal } from "./modal/EditTestQuestionModal"
import { DeleteTestQuestionModal } from "./modal/DeleteTestQuestionModal"
...
export default function TestQuestionaire({ params } : { params : { id: string } }) 
{
    ...
    const { data, isLoading, refetch, isRefetching } = useQuery({ queryKey: [`get-all-test-questions`, token], queryFn: () => QuestionaireQuestion(page, token)})
    ...
    const [editData, setEditData] = useState<
                                                { question_id: number, course_id: number, question: string, option_a: string, option_b: string, option_c: string, option_d: string, answer: string, assigned_mark: string }
                                            >(
                                                { question_id: -1, course_id: -1, question: "", option_a: "", option_b: "", option_c: "", option_d: "", answer: "", assigned_mark: "" }
                                             )
    ...
    return (
        ...
        > 
              <div 
                ...
                <div 
                    className="container mx-auto mb-14 md:mt-2"
                >
                  <div 
