...
import { RemoveQuestion } from "../../../../../api/admin/academic/test"
...
type DeleteCourseModalProps = 
{
   ...
   onClick: () => void
   token: string
   data: { question_id: number, course_id: number, question: string, option_a: string, option_b: string, option_c: string, option_d: string, answer: string, assigned_mark: string }
}

export const DeleteTestQuestionModal = ({onClick, data, openQuestionaire, token}: DeleteCourseModalProps)  =>
{
    const [loading, setIsLoading] = useState(false)
    const [id] = useState<number>(data?.question_id)
    ...
    {
       setIsLoading(true)
       const newCourse = RemoveQuestion(id, token)
    ...
    return (
                ...
                >
                    ...
                    >
                       ...
                       >
                          You are about to delete Course {data?.question}
                       </h1>
                       <span 
