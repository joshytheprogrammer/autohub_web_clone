...
export const ViewFaq = ({onClick, openViewDepartment, message}: ViewDepartmentProps)  =>
{
    ...
    return (
                <Modal 
                        onClick={onClick} isOpen={openViewDepartment} wrapperWidth={1000} margin={'100px auto 0px auto'}
                >
                        ...
                        <div className='col-span-12 pt-1 pb-5 overflow-y-auto xm:overflow-y-scroll justify-center item-center'>
                                ...
                                >
                                    <div 
                                        className="w-full border-2 border-shadow rounded-lg p-5 mb-5 md:mb-0"
                                    >
                                        one
                                    </div>
                                </div>
                                <div 
                                    className="mb-4 w-full d-flex md:flex border-2 border-shadow rounded-lg p-5 mb-5 md:mb-5"
                                >
                                  Full  
                                </div> 
                                <div 
