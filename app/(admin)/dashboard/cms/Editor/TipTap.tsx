...
{ 
   ...
   const [writeUp, setWriteUp] = useState<string>(advertState.getDescription())
    ...
    const editor = useEditor({
      ...
      editorProps: {
         attributes: {
            class: 'flex flex-col px-1 py-3 justify-start border-b border-r border-l border-gray-400 auto-scroll overflow-auto overflow-y-scroll h-[550px] shadow-md items-start w-full gap-3 font-medium text-[17px] pt-4 rounded-bl-md rounded-br-md outline-none'
         },
      },
      onUpdate:  ({ editor }) => 
      {
