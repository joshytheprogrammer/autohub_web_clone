...
import EnterClassRoom from "../../../components/shared/EnterClassRoom";
   ...
   useEffect(() => {
    ...
    return (
            ...
            > 
                ...
                >
                  {
                    token && isStudent && theStudent === "others" && <>
                      <div 
                        className="w-full p-5 d-flex justify-center items-center border-2 py-10 md:py-5 md:mb-0 mb-5 pb-10 shadow-md"
                        >
                        {/* <div 
                              className='container d-flex gap-10'
                        > */}
                              <div 
                                    className='w-2/2 pt-10'
                              >
                                    <h3 
                              ...
                              <div 
                                    className="w-12/12 md:px-10 p-3 md:px-9 md:pb-10 d-flex items-center justify-center rounded-md md:rounded-xl hover:text-white mb-5"
                              >
                                    ...
                                    >
                                          ...
                                          > 
                                                <div  
                                                      className='w-6/12 mx-auto d-flex gap-10 mb-3'
                                                > 
                                                      ...
                                                      <div 
                                                            className="mb-4 w-2/2 md:w-6/12 mx-auto"
                                                      >
                                                            <input  
                                                      ...
                                                      <div 
                                                            className="relative mb-4 w-2/2 md:w-6/12 mx-auto"
                                                      >
                                                            <input  
                                          ...
                                          <div  
                                                className='w-2/2 md:w-5/12 mx-auto flex justify-between md:flex gap-10 md:mb-3 mt-5'
                                          >   
                                                <button 
                                                      type='submit'
                  ...
                  }   
                  {
                    ...
                    <div 
                      className="md:w-12/12 w-full p-5 flex justify-center items-center border-2 py-10 md:py-0 md:mb-0 mb-40 shadow-md"
                    >
                      <div 
                        className="py-20"
                      >
                        <h3 
                          className="font-bold text-md text-center text-green-700 md:pt-20 md:pb-4"
                        >
                          Join Our Academy
                        </h3>
                        <div 
                          className="p-3 bg-blue-600 md:mb-24 text-center border border-4 border-blue-300 hover:border-green-500 text-blue-300 hover:text-white rounded-xl cursor-pointer"
                          onClick={
                            () => {
                                router.push(`/academy`)
                            }
                  ...
                  {  token && isStudent && theStudent === "student" && <EnterClassRoom /> }
                </div>
