            ...
            <>
                ...
                >      
                    ...
                    >
                        ...
                        { picture && <Image src={`${'https://server.trustedmiddleman.app/profile_picture/'}${picture}`} alt={`${picture}`} width={400} height={400} className='flex justify-left bg-blue-200 mb-3 rounded-xl' />   }
