...
export const SelectCountries = ({ countries, selectedCountryName, onChange }: SelectOptionTypes) => 
{
    ...
    {
       const OPTIONS = countries?.countries?.filter((x: any) => x?.name.toString().toLocaleLowerCase().indexOf(search.toString().toLowerCase()) !== -1)	
       return OPTIONS
    }, [countries, search])
            ...
            >
               ...
               >
                  ...
                  >                     
                     ...
                     {
                        countries?.countries?.length > 0 && search?.length === 0 && countries?.countries?.map((country: { id: number, name: string }, index: number) => 
                        {
                           return (
                              <li 
