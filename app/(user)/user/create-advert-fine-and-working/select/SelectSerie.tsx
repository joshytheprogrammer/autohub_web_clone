...
export const SelectSerie = ({ selectedManufacturer, selectedModel, selectedGeneration, series = [], onChange }: SelectOptionTypes) => 
{console.log(series)
    ...
    useEffect(() => 
    {
       setTimeout(() => 
      { 
         if((selectedManufacturer === -1 || selectedModel === -1 || selectedGeneration === -1) &&  (series?.length === 0 || series?.length === 0))
         {
            setPlaceHolder("First select a generation")
         }
