...
export const SelectTransmission = ({ transmission, onChange }: SelectOptionTypes) => 
{
    ...
    {
       const OPTIONS = transmission?.filter((x: any) => x?.name.toString().toLocaleLowerCase().indexOf(search.toString().toLowerCase()) !== -1)	
       return OPTIONS
    }, [transmission, search])
            ...
            >
               ...
               >
                  ...
                  >                     
                     ...
                     {
                        transmission?.length > 0 && search?.length === 0 && transmission?.map((transmission: { id: number, name: string }, index: number) => 
                        {
                           return (
                              <li 
