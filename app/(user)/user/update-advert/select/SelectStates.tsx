...
export const SelectStates = ({ selectedCountry, selectedState, selectedStateName, states = [], onChange }: SelectOptionTypes) => 
{
          ...
          {  
            if(advertState.getStateName()  === "")
            {
               ...
               if(selectedState === -1)
               {
                  ...
                  setSearch(advertState.getStateName())
                  setHoldData(advertState.getStateName()) 
               }
            }
          }, 100)
       }
                              ...
                              <li 
                                 ...
                                 onClick={
                                    () => {
                                       ...
                                       hasItem(state?.name)       
                                       advertState.setStates(state?.id)
                                       advertState.setStateName(state?.name) 
                                       advertState.setLGAS([])
                                       advertState.setLGA(-1)
                                       advertState.setOurLgaName("")
                                       setOpen(false)
