...
export const PreLoadingModal = ({onClick, preLoadModal, slug, mode}: PreloadProps)  =>
{
     ...
     {  
        ...
        advertState.setTransmissionName(data?.product?.transmission?.name)
        ...
        advertState.setMileage(data?.product?.mileage)
        ...
        advertState.setFuels(data?.fuels)
        advertState.setTransmissions(data?.transmission)
        advertState.setConditions(data?.condition)
